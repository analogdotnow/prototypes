...
function Toast(props: ToastProps) {
  ...
  return (
    <div
      className={cn(
        "relative mx-auto flex flex-col md:flex-row items-end rounded-xl bg-popover shadow-lg border border-border w-fit md:w-full px-4 py-3.5 gap-y-3 md:gap-y-0",
        {
